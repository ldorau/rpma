...
# to GitHub Container Registry. An empty file is created to signal that
# to further scripts.
#
...
# The Docker image will be pulled from the repository.

# Log in to GitHub Container Registry
echo "$GH_CR_PAT" | docker login https://ghcr.io -u="$GITHUB_ACTOR" --password-stdin
